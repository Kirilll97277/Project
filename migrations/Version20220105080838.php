 ...
 */
final class Version20220105080838 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE item ADD CONSTRAINT FK_1F1B251E41E2187D FOREIGN KEY (like_item_id) REFERENCES user (id)');
