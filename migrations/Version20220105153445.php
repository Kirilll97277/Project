 ...
 */
final class Version20220105153445 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE attribute_value (id INT AUTO_INCREMENT NOT NULL, attribute_type_id INT DEFAULT NULL, value VARCHAR(100) NOT NULL, INDEX IDX_FE4FBB824ED0D557 (attribute_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
